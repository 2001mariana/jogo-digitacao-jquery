...
function inserePlacar() {
    ...
    // var botaoRemover = "<a href='#' class='  waves-effect waves-light red botao-remover'><i class='material-icons'>delete</i></a>"
...
function novaLinha(usuario, numPalavras, fraseEscrita){
    ...
    var link = $("<a>").attr("href","#").addClass("botao-remover").addClass("btn-floating").addClass("btn-small");
