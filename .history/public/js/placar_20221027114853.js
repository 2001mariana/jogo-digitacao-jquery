...
function sincronizaPlacar(){
    ...
    linhas.each(function(){
        var usuario = $(this).find("td:nth-child(1)").tex();
        var palavras = $(this).find("td:nth-child(2)").tex();
        var frase = $(this).find("td:nth-child(3)").tex();

        console.log(usuario, palavras, frase)
    });
}